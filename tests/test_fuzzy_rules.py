...
from warc2zim.url_rewriting import HttpUrl, apply_fuzzy_rules
...
@pytest.fixture(
    params=[
        ...
        ContentForTests(
            ...
            "http://youtube.fuzzy.replayweb.page/videoplayback?id=1576",
        ),
        ContentForTests(
            "https://foobargooglevideo.com/videoplayback?id=1576&key=value",
            "https://youtube.fuzzy.replayweb.page/videoplayback?id=1576",
        ),
        ContentForTests(
...
@pytest.fixture(
    params=[
        ...
        ContentForTests(
            "http://www.youtube.com/get_video_info?video_id=123ah",
            "http://youtube.fuzzy.replayweb.page/get_video_info?video_id=123ah",
        ),
        ContentForTests(
            HttpUrl("https://www.youtube.com/get_video_info?video_id=123ah"),
            HttpUrl(
                "https://youtube.fuzzy.replayweb.page/get_video_info?video_id=123ah"
            ),
        ),
        ContentForTests(
        ...
        ContentForTests(
            HttpUrl("http://www.youtube-nocookie.com/get_video_info?foo=bar"),
        ),
        # improper hostname
        ContentForTests(
...
def test_fuzzyrules_google_video_infos(google_video_info_case):
    assert (
        apply_fuzzy_rules(google_video_info_case.input_)
        == google_video_info_case.expected
    )
...
@pytest.fixture(
    params=[
        ...
        ContentForTests(
            "http://www.youtube-nocookie.com/youtubei/page/?videoId=123ah",
            "http://youtube.fuzzy.replayweb.page/youtubei/page/?videoId=123ah",
        ),
        ContentForTests(
            "https://www.youtube-nocookie.com/youtubei/page/?videoId=123ah",
            "https://youtube.fuzzy.replayweb.page/youtubei/page/?videoId=123ah",
        ),
        ContentForTests(
...
@pytest.fixture(
    params=[
        ...
        ContentForTests(
            "http://www.youtube-nocookie.com/embed/bar",
            "http://youtube.fuzzy.replayweb.page/embed/bar",
        ),
        ContentForTests(
            "https://www.youtube-nocookie.com/embed/bar",
            "https://youtube.fuzzy.replayweb.page/embed/bar",
        ),
        ContentForTests(
...
@pytest.fixture(
    params=[
        ContentForTests(
            "youtube.fuzzy.replayweb.page/embed/foo?id=12",
            "youtube.fuzzy.replayweb.page/embed/foo",
        ),
        ContentForTests(
            "http://youtube.fuzzy.replayweb.page/embed/foo?id=12",
            "http://youtube.fuzzy.replayweb.page/embed/foo",
        ),
        ContentForTests(
            "https://youtube.fuzzy.replayweb.page/embed/foo?id=12",
            "https://youtube.fuzzy.replayweb.page/embed/foo",
        ),
        ContentForTests(
            "youtube.fuzzy.replayweb.page/embed/bar?id=12",
            "youtube.fuzzy.replayweb.page/embed/bar",
        ),
        ContentForTests(
            "youtube.fuzzy.replayweb.page/foo/bar?id=12",
        ),
    ]
)
...
def test_fuzzyrules_replay(replay_case):
    assert apply_fuzzy_rules(replay_case.input_str) == replay_case.expected_str
...
@pytest.fixture(
    params=[
        ...
        ContentForTests(
            "http://gcs-vimeo.akamaized.net/123.mp4",
            "http://vimeo-cdn.fuzzy.replayweb.page/123.mp4",
        ),
        ContentForTests(
            "https://gcs-vimeo.akamaized.net/123.mp4",
            "https://vimeo-cdn.fuzzy.replayweb.page/123.mp4",
        ),
        ContentForTests(
...
@pytest.fixture(
    params=[
        ...
        ContentForTests(
            "http://player.vimeo.com/video/123?foo=bar",
            "http://vimeo.fuzzy.replayweb.page/video/123",
        ),
        ContentForTests(
            "https://player.vimeo.com/video/123?foo=bar",
            "https://vimeo.fuzzy.replayweb.page/video/123",
        ),
        ContentForTests(
