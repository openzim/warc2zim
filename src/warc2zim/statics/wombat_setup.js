...
const getWombatInfo = function (
  ...
  const wbinfo = {
    ...
    // Use to send message to top frame and in default rewrite url fonction. Don't care
    request_ts: "",

    // The url only which we are served.
    prefix: prefix,
    ...
    // A delay is sec to aplly to all js time (`Date.now()`, ...)
    wombat_sec: 0,
